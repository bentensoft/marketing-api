    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('term', models.CharField(blank=True, db_index=True, max_length=255, null=True, verbose_name='Search Term')),
                ...
                ('client', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sqr_reports', to='clients.Client')),
            ],
            options={
                'ordering': ['term'],
            },
